...
export default function AirtimePurchase() {
  ...
  async function validatePhone(phone: string) {
    return new Promise<{ isValid: boolean }>((resolve) => {
      setTimeout(() => {
        // Simple validation - check if it's a valid phone number
  ...
  async function handleNext() {
    if (step === 1) {
      ...
      try {
        ...
        if (!data.isValid) {
          alert('Phone number validation failed. Please check the number and try again.');
          return;
        }
    ...
    <div className="w-full h-full overflow-hidden">
      ...
      >
        ...
        <div className="mb-4 md:mb-5 text-center border-b border-gray-200 dark:border-gray-700 pb-3">
          ...
          <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">Buy airtime for any network</p>
        </div>
            ...
            <motion.div key="step1" {...stepAnimation}>
              ...
              <div className="grid grid-cols-1 gap-3 md:gap-4">
                <div className="mb-3 md:mb-4">
                  <label htmlFor="provider" className="block mb-1 text-sm md:text-base text-gray-700 dark:text-gray-300 font-medium">
                    Select Provider
                  </label>
                  <select
                    id="provider"
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-3 md:p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-gray-700 dark:text-gray-300 text-sm md:text-base flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 极速赛车开奖直播 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    Phone Information
                  </h3>
          ...
          {step === 3 && (
            <motion.div key="step3" {...stepAnimation}>
              ...
              <div className="bg-[#ff660010] dark:bg-[#ff660020] p-3 md:p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-gray-700 dark:text-gray-300 text-sm md:text-base">Please confirm your airtime purchase</h3>
              ...
              >
                <div className="text-center mb-3 md:mb-4 border-b border-gray-200 dark:border-gray-600 pb-2 md:pb-3">
                  <div className="flex items-center justify-center space-x-1 md:space-x-2">
                    <div className="bg-[#ff6600] text-white p-1.5 md:p-2 rounded-full">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5" fill="none" viewBox="极速赛车开奖直播 0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 极速赛车开奖直播 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c极速赛车开奖直播 0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                      </svg>
                    </div>
                ...
                <div className="space-y-2 md:space-y-3 text-sm md:text-base">
                  <div className="grid grid-cols-2 gap-2 md:gap-3">
                    <div>
                      <p>
                        <strong className="block text-xs极速赛车开奖直播 md:text-sm text-gray-500 dark:text-gray-400">Receipt ID</strong>
                        {formData.receiptId}
                      </p>
                      <p className="mt-1 md:mt-2">
        ...
        <div className="mt-4 md:mt-5 flex flex-col-reverse sm:flex-row gap-2 md:gap-3 justify-between items-center">
          {step > 1 && step < 4 && (
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 极速赛车开奖直播 19l-7-7m0 0l极速赛车开奖直播 7-7m-7 7h18" />
              </svg>
              Back
            </button>
          )}
          ...
          {step === 3 && (
            <button
              onClick极速赛车开奖直播={handleNext}
              className="bg-[极速赛车开奖直播 #ff6600] hover:bg-[#e65c00] text-white px-3 py-1.5 md:px-4 md:py-2 rounded text-sm md:text-base w-full sm:w-auto font-semibold flex items-center justify-center"
            >
              Confirm Purchase
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-col sm:flex-row gap-2 md:gap-3 w-full">
              ...
              >
                <svg className="w-3 h-3 md:w-4 md:h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707极速赛车开奖直播 V19a2 2 0 01-2 2z"></path>
                </svg>
                Download Receipt
              </button>
              <button
