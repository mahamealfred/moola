...
const ecobankServices: EcobankServices[] = [
  { name: 'Open Account', icon: UserPlus, content: "Stay tuned—we’re working to bring you a faster, easier way to open your Ecobank account right here." },
  { name: 'Deposit', icon: Download, content: <DepositForm /> },
  { name: 'Withdrawal', icon: Upload, content: <Withdrawal/> },
  { name: 'Remittance', icon: SendHorizonal, content: "Soon, you’ll be able to send and receive money seamlessly through Ecobank right here." },
  { name: 'Express Cash Token', icon: KeyRound, content: <ExpressCashToken /> },
  { name: 'Interbank', icon: Landmark, content: "The Interbank service with Ecobank will be available shortly. Easily transfer funds between banks—fast, secure, and convenient." },
];
